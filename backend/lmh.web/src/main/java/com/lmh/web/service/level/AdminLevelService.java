package com.lmh.web.service.level;
...
public interface AdminLevelService {
    ...
    Page<AdminLevelResponse> getAllLevelsForAdmin(String searchTerm, Integer languageId, int page, int size, String sortBy, String sortDir);

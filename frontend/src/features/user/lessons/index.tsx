...
import { BookOpen, ChevronLeft, Loader2, Play, Plus, Edit, Trash2 } from 'lucide-react';
...
export default function LessonsPage({ levelId, levelName, languageName, topicId, topicName, userId }: LessonsPageProps) {
      ...
      <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Bạn có chắc chắn muốn xóa bài học "{deletingLesson?.name}"? 
